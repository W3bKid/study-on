 ...
 */
final class Version20240902153202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT NOT NULL, course_id INT NOT NULL, title VARCHAR(255) NOT NULL, content TEXT NOT NULL, order_number INT NOT NULL, PRIMARY KEY(id))');
